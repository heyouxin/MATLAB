function [y,pi,i,r,QQ,SS]=newkeynesian(epsilon_v,epsilon_a,epsilon,theta,Phi_pi,Phi_y)
...
v=zeros(1,20);a=zeros(1,20);z=zeros(2,20);
pi=zeros(1,20);y=zeros(1,20);rn=zeros(1,20);
i=zeros(1,20);r=zeros(1,20);
v(1)=epsilon_v;
a(1)=epsilon_a;
for t=1:20
    if t==1
